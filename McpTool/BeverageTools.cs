...
[McpServerToolType]
public class BeverageTools
{
    private readonly BeverageDbService _beverageService;
    private readonly ApplicationDbContext _db;

    public BeverageTools(ApplicationDbContext db)
    {
        _db = db;
        _beverageService = new BeverageDbService(_db);
    }
